...
详见 [[concepts/ai-agent-overview|AI Agent 概述]] 和 [[concepts/hybrid-retrieval-bm25-semantic-fusion|混合检索]]。
...
- RAG：[[concepts/rag-retrieval-augmented-generation|RAG 检索增强生成]]
