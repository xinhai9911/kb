---
aliases: ["advanced-color-grading"]
title: 调色进阶
category: concepts
...
[[concepts/调色 调色 工作流|色彩管理管线]]覆盖了一级/二级调色的基础知识。本篇向上延伸，深入 ACES 标准、HDR 工作流、风格化调色流派、以及调色在叙事层面的心理作用。
...
见 [[entities/调色师 调色]] 合集页。

## 关联页面

- [[concepts/调色 调色 工作流]] — 色彩管理基础（本页的向上延伸基础）
- [[concepts/叙事 心理学 剪辑]] — 剪辑叙事心理学
- [[entities/DaVinci Resolve]] — 行业标准调色工具
- [[entities/调色师 调色]] — 知名调色师合集
