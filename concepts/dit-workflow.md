...
- [[concepts/storage-archive-strategy|存储与归档策略]] — 3-2-1 法则详细说明
- [[concepts/proxy-workflow|代理工作流]] — 日报生成相关
- [[concepts/camera-raw-formats|摄影机 RAW 格式]] — DIT 最常处理的格式
- [[concepts/mezzanine-codec|中间件编码]] — 代理编码选择
- [[concepts/delivery-codec|交付 Codec 选择]]
- [[concepts/color-grading-workflow|调色工作流]] — CDL → 后期调色衔接
