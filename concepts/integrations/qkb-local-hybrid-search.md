...
- [[concepts/hybrid-retrieval-bm25-semantic-fusion|关键词检索（BM25）+ 语义检索双路，融合排序]] —— qkb 的设计 spec
- [[concepts/transformer-architecture|Transformer 架构]] —— bge 模型底层
- [[concepts/agent-memory-planning|Agent 记忆与规划]] —— RAG / 长期记忆的工程实现
- [[concepts/mcp-protocol|Model Context Protocol]] —— qkb 暴露 tool 给 Claude Code 的协议层
