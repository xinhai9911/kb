...
> 若你还没读过《[[00-index/how-to-use|如何使用本知识库]]》，请先看它了解分类体系与
...
| **Linter** | 统一 frontmatter、标题层级 | 批量整理笔记格式，配合 [[00-index/how-to-use|提交约定]] |
...
1. **新增笔记**：按 [[00-index/how-to-use|使用说明]] 建文件 + frontmatter + 带路径双链。
...
- [[00-index/tag-glossary|标签字典]] — 标签含义对照
- [[50-reference/obsidian-plugins|Obsidian 已安装插件说明]] — 本库实际装的 11 个社区插件清单
