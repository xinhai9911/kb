---
aliases: ["es-book-08-tech-analysis"]
...
- **关联**：ELK 链路与 [[50-reference/sources/chips/3 TAP]]（流量可视化）、[[20-protocols/Elasticsearch 2]] 协议层互补；Nginx 日志范例可与 [[50-reference/sources/books/网络 HCNA HCNP]] 运维场景对照；映射/分词思路用于日志字段设计。
