...
- 与 [[50-reference/sources/chips/Centec SDK]]、[[50-reference/sources/chips/Centec CTC 8180]] 配套使用；CTC8180 为增强款，特性更全（ACL 16 次查找 / FlexE / MPLS / SRv6 / QoS 12K 队列）。

## 关联

- SDK/开发：[[50-reference/sources/chips/Centec SDK]]
- 同系升级款：[[50-reference/sources/chips/Centec CTC 8180]]
- 网络原理基础：[[50-reference/sources/books/网络 HCNA HCNP]]
