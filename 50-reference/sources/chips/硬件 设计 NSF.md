...
## 适用场景
- 硬件方案评审、板卡接口对接时回查规格。
- 与交换芯片 [[50-reference/sources/chips/Centec CTC 7132]] / [[50-reference/sources/chips/Centec CTC 8180]] 配套理解整机设计。

## 关联
- 交换芯片：[[50-reference/sources/chips/Centec CTC 7132]]、[[50-reference/sources/chips/Centec CTC 8180]]
