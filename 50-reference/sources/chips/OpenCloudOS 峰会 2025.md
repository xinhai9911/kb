---
aliases: ["opencloudos-summit-2025"]
...
- **可观测主线贯穿全场**：perf-prof（工具）、HUATUO（内核全景）、OCAI（智能体运维）、云原生可观测（李辉）——与 [[50-reference/NPP 定时器 机制]]（观测/定时器机制）主题同源，但本大会侧重"操作系统级全景观测 + AI 运维"，而非内核定时器实现。eBPF 是 HUATUO/perf-prof 等工具的内核观测底座。
...
- 内核观测/定时器机制：[[50-reference/NPP 定时器 机制]]
- 动态库/运行时机制：[[50-reference/dlopen internal 内存]]
