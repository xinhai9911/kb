...
> ⚠️ **WB4U11U 框式机架 PDF 无文本层**：`WB4U11U框式机架框图-各板卡规格及软硬件接口文档-20240629【NSF】.pdf`（~7 MB）读取为 0 页/纯图片型，未能提取文字，待 OCR 或文件修复。**但同批 `NSF1N10TG801MA-NSF1N10TG8B01MA硬件设计报告V1.1.docx` 已成功提取**（见下方深度提炼）。
> 原始路径：`Q:\芯片资料\`
...
| WB4U11U框式机架框图-各板卡规格及软硬件接口文档-20240629【NSF】.pdf | ~7 MB | WB4U11U 框式机架框图、板卡规格与软硬接口 | ⚠️0页/纯图片·待OCR |
...
> 注：WB4U11U 框式机架（机框背板、线卡/主控卡规格、软硬件接口）仍待 OCR，以下"框式机架"要点为文件名推测，未核实。

- **框式机架（待 OCR）**：机框背板、线卡/主控卡规格、软硬件接口定义。
