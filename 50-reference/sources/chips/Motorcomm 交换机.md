...
- 低端交换机 / 嵌入式交换方案开发时回查。
- 与盛科管理型交换芯片 [[50-reference/sources/chips/Centec CTC 7132]] 对比定位。

## 关联

- 盛科交换芯片：[[50-reference/sources/chips/Centec CTC 7132]]、[[50-reference/sources/chips/Centec CTC 8180]]
...
- 管理型交换对照：[[50-reference/sources/chips/Centec CTC 7132]]、[[50-reference/sources/chips/Centec CTC 8180]]、[[50-reference/sources/chips/Centec SDK]]
