...
配套阅读：[[50-reference/obsidian-usage|Obsidian 使用方法]]。
...
**在本库的操作示例**
1. 打开 `projects/README` —— 其「速览表」已用 Dataview 渲染（见 [[50-reference/obsidian-plugins|下文]]）；
...
**小贴士**
- 导入后务必跑链接审计（见 [[50-reference/obsidian-usage|Obsidian 使用方法]] 的维护流程），
  外部双链风格可能不一致。
...
- [[50-reference/obsidian-usage|Obsidian 使用方法]] — 上手与日常维护流程
- [[50-reference/callout-conventions|全库 Callout 使用清单与规范]] — 各类型约定与待补候选
- [[00-index/how-to-use|如何使用本知识库]] — 分类体系与 frontmatter 规范
