...
created: 2026-07-29
summary: >-
    FPGA 日常开发实操：开源仿真（iverilog/Verilator/GTKWave）、商业综合实现（Vivado/Quartus）流程、跨时钟域(CDC)写法、测试平台(testbench)范式、Makefile 一键流程，以及本地 Q:/AI/vhdl_examples 示例。配合 [[20-protocols/fpga|FPGA 知识]]。
category: reference
updated: 2026-07-29
sources: []
base_confidence: 0.8
...
> 知识背景见 [[20-protocols/fpga|FPGA 知识]]。本文是"怎么动手"的操作手册。
...
- 芯片资料：[[50-reference/sources/chips/centec-ctc7132|CTC7132]]（FPGA 常与之配合做灵活前端）
