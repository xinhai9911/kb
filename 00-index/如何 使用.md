...
4. 写正文。多用双链 `[[sources/推理引擎/LLM 推理 优化]]` 关联已有笔记
...
- Obsidian：装在 `Q:\AI\kb`，双链可点跳，全文搜索。详见 [[50-reference/Obsidian 用法|Obsidian 使用方法]]。

## 双链语法

- 优先用带路径的双链：`[[concepts/Transformer 架构|Transformer]]`
