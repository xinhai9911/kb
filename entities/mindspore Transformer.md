---
aliases: ["mindspore-transformers"]
...
- → [[LLM 推理 优化]] — 推理优化总论（量化/蒸馏/加速框架）
- → [[推理 引擎 选择]] — 推理引擎选型（vLLM/TGI/TensorRT-LLM 对比）
- → [[50-reference/sources/chips/GPU AI 加速器|GPU 与 AI 加速芯片架构]] — 昇腾硬件背景
- → [[concepts/Transformer 架构|Transformer 架构]] — MindFormers 的模型基础
