...
2017 年 Google 团队的 Vaswani 等人提出了 Transformer 架构，完全基于注意力机制、摒弃循环神经网络（RNN）和卷积神经网络（CNN）。该论文是今天 [[concepts/transformer-architecture|大语言模型]] 的奠基性工作。
...
- [[concepts/llm-inference-optimization|推理优化]] 领域的 FlashAttention、PagedAttention 解决其 O(n²) 瓶颈
